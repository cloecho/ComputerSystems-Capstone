...
//rg added
   private JPanel setUpSideMenu()
   {
      ...
      JButton button_pinkScale = new JButton("Pink Scale");
      button_pinkScale.addActionListener(new Listener_pinkScale());
      sub_panel.add(button_pinkScale);
      
      JButton button_mirrorVerticalRightToLeft = new JButton("mirrorVerticalRightToLeft");
      button_mirrorVerticalRightToLeft.addActionListener(new Listener_mirrorVerticalRightToLeft());
      sub_panel.add(button_mirrorVerticalRightToLeft);
      
      JButton button_mirrorHorizontalBotToTop = new JButton("mirrorHorizontalBotToTop");
      button_mirrorHorizontalBotToTop.addActionListener(new Listener_mirrorHorizontalBotToTop());
      sub_panel.add(button_mirrorHorizontalBotToTop);
      
      JButton button_mirrorDiagonalOpposite = new JButton("mirrorDiagonalOpposite");
      button_mirrorDiagonalOpposite.addActionListener(new Listener_mirrorDiagonalOpposite());
      sub_panel.add(button_mirrorDiagonalOpposite);
...
*/
   ...
   */
   ...
   public class Listener_pinkScale implements ActionListener
   {
      public void actionPerformed(ActionEvent e){
         ((Picture)picture).pinkScale();
         updatePicture();
      }
   }
  
   public class Listener_mirrorVerticalRightToLeft implements ActionListener
   {
      public void actionPerformed(ActionEvent e){
   ...
   public class Listener_mirrorHorizontalBotToTop implements ActionListener
   {
      public void actionPerformed(ActionEvent e){
   ...
   public class Listener_mirrorDiagonalOpposite implements ActionListener
   {
      public void actionPerformed(ActionEvent e){
